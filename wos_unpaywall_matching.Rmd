...
```{r}
# Create table
dbGetQuery(con, read_file("sql/normalise_upw_14.sql.sql"))
# Add index on DOI column
dbGetQuery(con, read_file("sql/normalise_upw_14_index.sql.sql"))
# Create table
dbGetQuery(con, read_file("sql/normalise_wos_12_17.sql.sql"))
# Add index on DOI column
dbGetQuery(con, read_file("sql/normalise_wos_12_17_index.sql.sql"))
...
doi_matches_authorcounts %>%
  ...
  geom_tile(aes(fill=log(MATCHES+1))) +
