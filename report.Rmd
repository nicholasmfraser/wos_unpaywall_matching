...
<!-- add figure?-->
<!--how to compare to number of wos  records? just 14 and 14?-->
...
what to do with very similar titles? 

instead of excluding records with duplicate title maybe choose one of them?

include authornames?

runtime several hours for one upw year, does it scale?

used preimplemented author count in wos -> how reliable?

recommendations:

for recent years, if runtime is issue: just use doi

if more is wanted: final criterion: title similarity. use other arguments to reduce number of titles that have to be compared
